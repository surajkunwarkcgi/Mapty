...
// const run1 = new Running([28.476395, 84.689751], 5.2, 24, 178);
// const cycling1 = new Cycling([28.476395, 84.689751], 27, 95, 523);
...
class App {
  ...
  _newWorkout(e) {
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp)); //rest parameter returns an array,
    //so we are able to use 'every' method
